...
class GW20KAU_DT_Test(DtMock):
    ...
    def test_GW20KAU_DT_runtime_data(self):
        ...
        self.assertSensor('xx68', 0, '', data)
        self.assertSensor('xx70', 0, '', data)
        self.assertSensor('xx72', 205, '', data)
        self.assertSensor('xx74', 0, '', data)
        self.assertSensor('xx76', 0, '', data)
        self.assertSensor('xx78', 999, '', data)
        self.assertSensor('xx80', -1, '', data)
        ...
        self.assertSensor('xx130', 0, '', data)
        self.assertSensor('xx132', 4, '', data)
        self.assertSensor('xx134', 0, '', data)
        self.assertSensor('xx136', 1099, '', data)
        self.assertSensor('xx138', 0, '', data)
        self.assertSensor('xx140', 4, '', data)
        self.assertSensor('xx142', 0, '', data)
        self.assertSensor('xx144', 105, '', data)
