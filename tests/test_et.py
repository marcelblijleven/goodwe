...
class GW20K_ET_Test(EtMock):
    ...
    def test_GW20K_ET_runtime_data(self):
        ...
        self.assertSensor('ppv5', 0, 'W', data)
        self.assertSensor('ppv6', 0, 'W', data)
        self.assertSensor('ppv7', 0, 'W', data)
        self.assertSensor('ppv8', 0, 'W', data)
        self.assertSensor('ppv9', 0, 'W', data)
        self.assertSensor('ppv10', 0, 'W', data)
        self.assertSensor('ppv11', 0, 'W', data)
        self.assertSensor('ppv12', 0, 'W', data)
        self.assertSensor('ppv13', 0, 'W', data)
        self.assertSensor('ppv14', 0, 'W', data)
        self.assertSensor('ppv15', 0, 'W', data)
        self.assertSensor('ppv16', 0, 'W', data)
...
class GW25K_ETA_G20_Test(EtMock):

    def __init__(self, methodName="runTest"):
        EtMock.__init__(self, methodName)
        self.mock_response(self._READ_DEVICE_VERSION_INFO, "GW25K-ETA-G20_device_info.hex")
        self.mock_response(self._READ_RUNNING_DATA, "GW25K-ETA-G20_running_data.hex")
        self.mock_response(self._READ_METER_DATA_EXTENDED2, "GW25K-ETA-G20_meter_data.hex")
        self.mock_response(self._READ_BATTERY_INFO, "GW25K-ETA-G20_battery_info.hex")
        self.mock_response(self._READ_MPPT_DATA, "GW25K-ETA-G20_mppt_data.hex")

    def test_GW25K_ETA_G20_device_info(self):
        self.loop.run_until_complete(self.read_device_info())
        self.assertEqual("\u4757\u4757\u4757", self.model_name)
        self.assertEqual("9025KNBG00000000", self.serial_number)
        self.assertEqual(20480, self.rated_power)
        self.assertEqual(101, self.modbus_version)
        self.assertEqual(1, self.dsp1_version)
        self.assertEqual(1, self.dsp2_version)
        self.assertEqual(1051, self.dsp_svn_version)
        self.assertEqual(3, self.arm_version)
        self.assertEqual(173, self.arm_svn_version)
        self.assertEqual("04098-01-S51", self.firmware)
        self.assertEqual("02203-03-S01", self.arm_firmware)
        # No 2nd battery; MPPT block enabled purely via rated_power >= 15000
        self.assertFalse(self._has_battery2)
        self.assertTrue(self._has_mppt)

    def test_GW25K_ETA_G20_runtime_data(self):
        self.loop.run_until_complete(self.read_device_info())
        ...
        self.assertSensor("timestamp", datetime.strptime("2026-07-29 10:37:46", "%Y-%m-%d %H:%M:%S"), "", data)
        self.assertSensor("vpv1", 475.8, "V", data)
        self.assertSensor("ipv1", 9.1, "A", data)
        self.assertSensor("ppv1", 4390, "W", data)
        self.assertSensor("vpv2", 210.3, "V", data)
        self.assertSensor("ipv2", 6.4, "A", data)
        self.assertSensor("ppv2", 1343, "W", data)
        self.assertSensor("vpv3", 479.4, "V", data)
        self.assertSensor("ipv3", 8.9, "A", data)
        self.assertSensor("ppv3", 4347, "W", data)
        self.assertSensor("vpv4", 479.4, "V", data)
        self.assertSensor("ipv4", 0.0, "A", data)
        self.assertSensor("ppv4", 4004, "W", data)
        self.assertSensor("ppv", 14084, "W", data)
        self.assertSensor("pv4_mode", 2, "", data)
        ...
        self.assertSensor("pv1_mode", 2, "", data)
        self.assertSensor("pv1_mode_label", "PV panels connected, producing power", "", data)
        self.assertSensor("vgrid", 235.9, "V", data)
        self.assertSensor("igrid", 19.5, "A", data)
        self.assertSensor("fgrid", 50.02, "Hz", data)
        self.assertSensor("pgrid", 4604, "W", data)
        self.assertSensor("vgrid2", 234.9, "V", data)
        self.assertSensor("igrid2", 19.6, "A", data)
        self.assertSensor("fgrid2", 50.02, "Hz", data)
        self.assertSensor("pgrid2", 4604, "W", data)
        self.assertSensor("vgrid3", 236.9, "V", data)
        self.assertSensor("igrid3", 19.4, "A", data)
        self.assertSensor("fgrid3", 50.02, "Hz", data)
        self.assertSensor("pgrid3", 4603, "W", data)
        self.assertSensor("grid_mode", 1, "", data)
        self.assertSensor("grid_mode_label", "Connected to grid", "", data)
        self.assertSensor("total_inverter_power", 13811, "W", data)
        self.assertSensor("active_power", 12691, "W", data)
        self.assertSensor("grid_in_out", 1, "", data)
        self.assertSensor("grid_in_out_label", "Exporting", "", data)
        self.assertSensor("reactive_power", -52, "var", data)
        self.assertSensor("apparent_power", 13823, "VA", data)
        self.assertSensor("backup_v1", 235.9, "V", data)
        self.assertSensor("backup_i1", 2.0, "A", data)
        self.assertSensor("backup_f1", 50.02, "Hz", data)
        self.assertSensor("load_mode1", 0, "", data)
        self.assertSensor("backup_p1", 163, "W", data)
        self.assertSensor("backup_v2", 234.9, "V", data)
        self.assertSensor("backup_i2", 3.4, "A", data)
        self.assertSensor("backup_f2", 50.02, "Hz", data)
        self.assertSensor("load_mode2", 0, "", data)
        self.assertSensor("backup_p2", 435, "W", data)
        self.assertSensor("backup_v3", 236.8, "V", data)
        self.assertSensor("backup_i3", 3.4, "A", data)
        self.assertSensor("backup_f3", 50.02, "Hz", data)
        self.assertSensor("load_mode3", 0, "", data)
        self.assertSensor("backup_p3", 473, "W", data)
        self.assertSensor("load_p1", 6, "W", data)
        self.assertSensor("load_p2", 15, "W", data)
        self.assertSensor("load_p3", 25, "W", data)
        self.assertSensor("backup_ptotal", 1072, "W", data)
        self.assertSensor("load_ptotal", 48, "W", data)
        self.assertSensor("ups_load", 4, "%", data)
        self.assertSensor("temperature_air", 50.2, "C", data)
        self.assertSensor("temperature_module", 51.2, "C", data)
        self.assertSensor("temperature", 46.1, "C", data)
        self.assertSensor("function_bit", 386, "", data)
        self.assertSensor("bus_voltage", 759.8, "V", data)
        self.assertSensor("nbus_voltage", 379.9, "V", data)
        self.assertSensor("vbattery1", 760.3, "V", data)
        self.assertSensor("ibattery1", 0.0, "A", data)
        self.assertSensor("pbattery1", 15, "W", data)
        self.assertSensor("battery_mode", 1, "", data)
        self.assertSensor("battery_mode_label", "Standby", "", data)
        self.assertSensor("warning_code", 0, "", data)
        self.assertSensor("safety_country", 66, "", data)
        self.assertSensor("safety_country_label", "CH", "", data)
        self.assertSensor("work_mode", 1, "", data)
        self.assertSensor("work_mode_label", "Normal (On-Grid)", "", data)
        self.assertSensor("operation_mode", 2, "", data)
        self.assertSensor("error_codes", 0, "", data)
        self.assertSensor("errors", "", "", data)
        self.assertSensor("e_total", 1796.6, "kWh", data)
        self.assertSensor("e_day", 28.8, "kWh", data)
        self.assertSensor("e_total_exp", 1670.8, "kWh", data)
        self.assertSensor("h_total", 308, "h", data)
        self.assertSensor("e_day_exp", 17.2, "kWh", data)
        self.assertSensor("e_total_imp", 0.0, "kWh", data)
        self.assertSensor("e_day_imp", 0.0, "kWh", data)
        self.assertSensor("e_load_total", 314.2, "kWh", data)
        self.assertSensor("e_load_day", 9.9, "kWh", data)
        self.assertSensor("e_bat_charge_total", 176.4, "kWh", data)
        self.assertSensor("e_bat_charge_day", 15.7, "kWh", data)
        self.assertSensor("e_bat_discharge_total", 150.7, "kWh", data)
        self.assertSensor("e_bat_discharge_day", 7.3, "kWh", data)
        self.assertSensor("diagnose_result", 262144, "", data)
        self.assertSensor("diagnose_result_label", "BMS: Charge disabled", "", data)
        self.assertSensor("house_consumption", 1408, "W", data)
        self.assertSensor("commode", 1, "", data)
        self.assertSensor("rssi", 0, "", data)
        self.assertSensor("manufacture_code", 10, "", data)
        self.assertSensor("meter_test_status", 0, "", data)
        self.assertSensor("meter_comm_status", 1, "", data)
        self.assertSensor("active_power1", 4430, "W", data)
        self.assertSensor("active_power2", 4108, "W", data)
        self.assertSensor("active_power3", 4102, "W", data)
        self.assertSensor("active_power_total", 12642, "W", data)
        self.assertSensor("reactive_power_total", 1091, "var", data)
        self.assertSensor("meter_power_factor1", 0.998, "", data)
        self.assertSensor("meter_power_factor2", 0.994, "", data)
        self.assertSensor("meter_power_factor3", 0.994, "", data)
        self.assertSensor("meter_power_factor", 0.996, "", data)
        self.assertSensor("meter_freq", 50.03, "Hz", data)
        self.assertSensor("meter_e_total_exp", 0.0, "kWh", data)
        self.assertSensor("meter_e_total_imp", 0.0, "kWh", data)
        self.assertSensor("meter_active_power1", 4430, "W", data)
        self.assertSensor("meter_active_power2", 4108, "W", data)
        self.assertSensor("meter_active_power3", 4102, "W", data)
        self.assertSensor("meter_active_power_total", 12683, "W", data)
        self.assertSensor("meter_reactive_power1", 234, "var", data)
        self.assertSensor("meter_reactive_power2", 413, "var", data)
        self.assertSensor("meter_reactive_power3", 443, "var", data)
        self.assertSensor("meter_reactive_power_total", 1091, "var", data)
        self.assertSensor("meter_apparent_power1", 4436, "VA", data)
        self.assertSensor("meter_apparent_power2", 4129, "VA", data)
        self.assertSensor("meter_apparent_power3", 4126, "VA", data)
        self.assertSensor("meter_apparent_power_total", 12688, "VA", data)
        self.assertSensor("meter_type", 255, "", data)
        self.assertSensor("meter_sw_version", 0, "", data)
        self.assertSensor("meter2_active_power", 0, "W", data)
        self.assertSensor("meter2_e_total_exp", 0.0, "kWh", data)
        self.assertSensor("meter2_e_total_imp", 0.0, "kWh", data)
        self.assertSensor("meter2_comm_status", 0, "", data)
        self.assertSensor("meter_voltage1", 235.7, "V", data)
        self.assertSensor("meter_voltage2", 234.5, "V", data)
        self.assertSensor("meter_voltage3", 235.8, "V", data)
        self.assertSensor("meter_current1", 19.1, "A", data)
        self.assertSensor("meter_current2", 17.9, "A", data)
        self.assertSensor("meter_current3", 17.7, "A", data)
        self.assertSensor("meter_e_total_exp1", 0.0, "kWh", data)
        self.assertSensor("meter_e_total_exp2", 0.0, "kWh", data)
        self.assertSensor("meter_e_total_exp3", 0.0, "kWh", data)
        self.assertSensor("meter_e_total_imp1", 0.0, "kWh", data)
        self.assertSensor("meter_e_total_imp2", 0.0, "kWh", data)
        self.assertSensor("meter_e_total_imp3", 0.0, "kWh", data)
        self.assertSensor("battery_bms", 0, "", data)
        self.assertSensor("battery_index", 465, "", data)
        self.assertSensor("battery_status", 1, "", data)
        self.assertSensor("battery_temperature", 32.8, "C", data)
        self.assertSensor("battery_charge_limit", 0, "A", data)
        self.assertSensor("battery_discharge_limit", 321, "A", data)
        self.assertSensor("battery_error_l", 0, "", data)
        self.assertSensor("battery_soc", 100, "%", data)
        self.assertSensor("battery_soh", 100, "%", data)
        self.assertSensor("battery_modules", 1, "", data)
        self.assertSensor("battery_warning_l", 0, "", data)
        self.assertSensor("battery_protocol", 294, "", data)
        self.assertSensor("battery_error_h", 0, "", data)
        self.assertSensor("battery_error", "", "", data)
        self.assertSensor("battery_warning_h", 0, "", data)
        self.assertSensor("battery_warning", "", "", data)
        self.assertSensor("battery_sw_version", 1544, "", data)
        self.assertSensor("battery_hw_version", 11, "", data)
        self.assertSensor("battery_max_cell_temp_id", 817, "", data)
        self.assertSensor("battery_min_cell_temp_id", 273, "", data)
        self.assertSensor("battery_max_cell_voltage_id", 1585, "", data)
        self.assertSensor("battery_min_cell_voltage_id", 6433, "", data)
        self.assertSensor("battery_max_cell_temp", 36.0, "C", data)
        self.assertSensor("battery_min_cell_temp", 30.0, "C", data)
        self.assertSensor("battery_max_cell_voltage", 3.463, "V", data)
        self.assertSensor("battery_min_cell_voltage", 3.397, "V", data)
        self.assertSensor("ppv_total", 14082, "W", data)
        self.assertSensor("pv_channel", 0, "", data)
        self.assertSensor("vpv5", 360.7, "V", data)
        self.assertSensor("ipv5", 4.3, "A", data)
        self.assertSensor("ppv5", 1551, "W", data)
        self.assertSensor("vpv6", 360.7, "V", data)
        self.assertSensor("ipv6", 6.8, "A", data)
        self.assertSensor("ppv6", 2453, "W", data)
        self.assertSensor("vpv7", 0, "V", data)
        self.assertSensor("ipv7", 0, "A", data)
        self.assertSensor("ppv7", 0, "W", data)
        self.assertSensor("vpv8", 0, "V", data)
        self.assertSensor("ipv8", 0, "A", data)
        self.assertSensor("ppv8", 0, "W", data)
        self.assertSensor("vpv9", 0, "V", data)
        self.assertSensor("ipv9", 0, "A", data)
        self.assertSensor("ppv9", 0, "W", data)
        self.assertSensor("vpv10", 0, "V", data)
        self.assertSensor("ipv10", 0, "A", data)
        self.assertSensor("ppv10", 0, "W", data)
        self.assertSensor("vpv11", 0, "V", data)
        self.assertSensor("ipv11", 0, "A", data)
        self.assertSensor("ppv11", 0, "W", data)
        self.assertSensor("vpv12", 0, "V", data)
        self.assertSensor("ipv12", 0, "A", data)
        self.assertSensor("ppv12", 0, "W", data)
        self.assertSensor("vpv13", 0, "V", data)
        self.assertSensor("ipv13", 0, "A", data)
        self.assertSensor("ppv13", 0, "W", data)
        self.assertSensor("vpv14", 0, "V", data)
        self.assertSensor("ipv14", 0, "A", data)
        self.assertSensor("ppv14", 0, "W", data)
        self.assertSensor("vpv15", 0, "V", data)
        self.assertSensor("ipv15", 0, "A", data)
        self.assertSensor("ppv15", 0, "W", data)
        self.assertSensor("vpv16", 0, "V", data)
        self.assertSensor("ipv16", 0, "A", data)
        self.assertSensor("ppv16", 0, "W", data)
        self.assertSensor("pmppt1", None, "W", data)
        self.assertSensor("pmppt2", None, "W", data)
        self.assertSensor("pmppt3", None, "W", data)
        self.assertSensor("pmppt4", None, "W", data)
        self.assertSensor("pmppt5", None, "W", data)
        self.assertSensor("pmppt6", None, "W", data)
        self.assertSensor("pmppt7", None, "W", data)
        self.assertSensor("pmppt8", None, "W", data)
        self.assertSensor("imppt1", 9.2, "A", data)
        self.assertSensor("imppt2", 6.4, "A", data)
        self.assertSensor("imppt3", 9.1, "A", data)
        self.assertSensor("imppt4", 11.0, "A", data)
        self.assertSensor("imppt5", 0, "A", data)
        self.assertSensor("imppt6", 0, "A", data)
        self.assertSensor("imppt7", 0, "A", data)
        self.assertSensor("imppt8", 0, "A", data)
        self.assertSensor("reactive_power1", -28, "var", data)
        self.assertSensor("reactive_power2", -29, "var", data)
        self.assertSensor("reactive_power3", -29, "var", data)
        self.assertSensor("apparent_power1", 4600, "VA", data)
        self.assertSensor("apparent_power2", 4601, "VA", data)
        self.assertSensor("apparent_power3", 0, "VA", data)
...
class GW29K9_ET_Test(EtMock):
    ...
    def test_GW29K9_ET_runtime_data(self):
        ...
        self.assertSensor("vpv16", 0.0, "V", data)
        self.assertSensor("ipv16", 0.0, "A", data)
        self.assertSensor("ppv5", 603, "W", data)
        self.assertSensor("ppv6", 0, "W", data)
        self.assertSensor("ppv7", 0, "W", data)
        self.assertSensor("ppv8", 0, "W", data)
        self.assertSensor("ppv9", 0, "W", data)
