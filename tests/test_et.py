...
class EtProtocolTest(TestCase):
    ...
    def test_GW10K_ET_runtime_data(self):
        ...
        self.assertSensor("load_total", 8820.2, 'kWh', data)
        self.assertSensor("load_day", 11.6, 'kWh', data)
        self.assertSensor("battery_charge_total", 2758.1, 'kWh', data)
        self.assertSensor("battery_charge_day", 5.3, 'kWh', data)
        self.assertSensor("battery_discharge_total", 2442.1, 'kWh', data)
        self.assertSensor("battery_discharge_day", 2.9, 'kWh', data)
