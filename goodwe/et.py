...
class ET(Inverter):
    ...
    __sensors: Tuple[Sensor, ...] = (
        ...
        Energy4("load_total", 206, "Total Load", Kind.AC),
        Energy("load_day", 210, "Today Load", Kind.AC),
        Energy4("battery_charge_total", 212, "Total Battery Charge", Kind.BAT),
        Energy("battery_charge_day", 216, "Today Battery Charge", Kind.BAT),
        Energy4("battery_discharge_total", 218, "Total Battery Discharge", Kind.BAT),
        Energy("battery_discharge_day", 222, "Today Battery Discharge", Kind.BAT),
