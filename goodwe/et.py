...
class ET(Inverter):
    ...
    __all_sensors: Tuple[Sensor, ...] = (
        ...
        Enum("pv2_mode_label", 40, PV_MODES, "PV2 Mode", None, Kind.PV),
        Byte("pv1_mode", 41, "PV1 Mode code", "", Kind.PV),
        Enum("pv1_mode_label", 41, PV_MODES, "PV1 Mode", None, Kind.PV),
        ...
        Enum2("grid_mode_label", 72, GRID_MODES, "Grid Mode", None, Kind.PV),
        ...
        Enum2("battery_mode_label", 168, BATTERY_MODES_ET, "Battery Mode", None, Kind.BAT),
        Integer("warning_code", 170, "Warning code"),
        Integer("safety_country", 172, "Safety Country code", "", Kind.AC),
        Enum2("safety_country_label", 172, SAFETY_COUNTRIES_ET, "Safety Country", None, Kind.AC),
        Integer("work_mode", 174, "Work Mode code"),
        Enum2("work_mode_label", 174, WORK_MODES_ET, "Work Mode", None),
